        ...
        <div class="row">
            ...
            ?>
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo '[' . $indicador['codigo'] . '] - ' . $indicador['nombre'] ?></h5>
                                <h6 class="card-subtitle mb-2 text-body-secondary"><?php echo $valor ?></h6>
                                <p class="card-text"><?php echo $texto_largo ?></p>
